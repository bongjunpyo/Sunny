    ...
    <>
      ...
      <div className={styles.layout}>
        ...
        <div>
          ...
          <section className={styles.group}>
            ...
            <select
              ...
              value={color}
              onChange={(event) => setColor(event.target.value as PhotochromicColor)}
            >
            ...
            <p className={styles.colorRow}>
              ...
              햇빛(자외선)을 만나면 이 색이 드러납니다. 정도는 농도 · 노출 시간 · 날씨에 따라 다릅니다.
            </p>
          </section>
          ...
          <section className={styles.group}>
            ...
            <p>{product ? `${KIND_LABEL[product.kind]} 기준 길이입니다.` : null}</p>
          </section>
          ...
          <section className={styles.group}>
            ...
            <label className={styles.file}>
              사진 고르기
              <input type="file" accept={PHOTO_RULES.accept.join(",")} onChange={onPickPhoto} />
            </label>
            ...
            <p className={styles.rules}>
              ...
              {PHOTO_RULES.provisional ? (
                <>
                  <br />이 규격은 <b>회의 전 임시값</b>입니다. 확정되면 서버가 알려주는 값으로
                  바뀝니다.
                </>
              ) : null}
            </p>
        ...
        <aside className={styles.summary} aria-label="구성 요약">
          ...
          <button type="button" className={styles.cta} onClick={() => setChecked(true)}>
            구성 확인
          </button>
          {checked ? (
